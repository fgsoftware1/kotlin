...
class JvmSharedVariablesManager(
    ...
    private fun unsafeCoerce(value: IrExpression, from: IrType, to: IrType): IrExpression =
        IrCallImpl(
            value.startOffset, value.endOffset, to, symbols.unsafeCoerceIntrinsic,
            symbols.unsafeCoerceIntrinsic.owner.typeParameters.size, symbols.unsafeCoerceIntrinsic.owner.valueParameters.size
        ).apply {
